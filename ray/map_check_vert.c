...
int quarter_one_xaxis(t_data *data)
{
    ...
    data->ray.tmp_y = data->player.y  - (tmp_cell_x /tan(data->player.angle));
    data->ray.map_check_x = x /data->map.map_size;
...
int quarter_two_xaxis(t_data *data)
{
    ...
    tmp_cell_x = data->map.map_size - data->player.cell_x;
    x = data->map.map_size * (data->player.map_x + 1);
    data->ray.tmp_y = data->player.y + (tan(data->player.tmp_angle) * tmp_cell_x);
    data->ray.map_check_x = x /data->map.map_size;
    data->ray.map_check_y = data->ray.tmp_y /data->map.map_size;
    return (0);
}
...
int quarter_three_xaxis(t_data *data)
{
    ...
    x = data->map.map_size * (data->player.map_x - 1);
    data->ray.tmp_y = data->player.y + (data->player.cell_x / tan(data->player.tmp_angle));
    data->ray.map_check_x = x /data->map.map_size;
    data->ray.map_check_y = data->ray.tmp_y /data->map.map_size;
    return (0);
}
...
int quarter_four_xaxis(t_data *data)
{
    ...
    x = data->map.map_size * (data->player.map_x - 1);
    data->ray.tmp_y = data->player.y - (tan(data->player.tmp_angle) * data->player.cell_x);
    data->ray.map_check_x = x /data->map.map_size;
    data->ray.map_check_y = data->ray.tmp_y /data->map.map_size;
    return (0);
}
