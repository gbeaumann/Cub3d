...
int check_forward_one(t_data *data)
{
    float new_angle;
    int   len;
    long double tmpx;
...
int check_forward_two(t_data *data)
{
    float new_angle;
    int   len;
    long double tmpx;
...
int check_forward_three(t_data *data)
{
    float new_angle;
    int   len;
    long double tmpx;
...
int check_forward_four(t_data *data)
{
    float new_angle;
    int   len;
    long double tmpx;
...
int check_forward(t_data *data)
{
    ...
    {
        if (check_forward_one(data))
            return (1);
    }
    if (data->ray[0].quarter == 2)
    {
        if (check_forward_two(data))
            return (1);
    }
    if (data->ray[0].quarter == 3)
    {
        if (check_forward_three(data))
            return (1);
    }
    if (data->ray[0].quarter == 4)
    {
        if (check_forward_four(data))
            return (1);
    }
    return (0);
}