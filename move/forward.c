...
int forward_one(t_data *data)
{
    ...
    if (data->ray[0].angle < PI/4)
    {
        ...
        data->player.x += data->map.move_size * (tan(data->ray[0].angle));
        data->player.cell_y -= data->map.move_size;
        data->player.cell_x += data->map.move_size * (tan(data->ray[0].angle));
    }
...
int forward_two(t_data *data)
{
    ...
    if (data->ray[0].tmp_angle < PI/4)
    {
        data->player.x += data->map.move_size;
        data->player.cell_x += data->map.move_size;
        data->player.y += data->map.move_size * (tan(data->ray[0].tmp_angle));
        data->player.cell_y += data->map.move_size * (tan(data->ray[0].tmp_angle));
    }
...
int forward_three(t_data *data)
{
    ...
    if (data->ray[0].tmp_angle < PI/4)
    {
        data->player.y += data->map.move_size;
        data->player.cell_y += data->map.move_size;
        data->player.x -= data->map.move_size * (tan(data->ray[0].tmp_angle));
        data->player.cell_x -= data->map.move_size * (tan(data->ray[0].tmp_angle));
    }
    else if (data->ray[0].tmp_angle > PI/4)
    {
        new_angle = PI/2 - data->ray[0].tmp_angle;
