...
{
    data->ray.ray_y += 60/cos(data->player.angle);
    data->ray.map_check_y -= 1;
    data->ray.tmp_x += 60 * (tan(data->player.angle));
...
{
    data->ray.ray_y += 60/sin(data->player.tmp_angle);
    data->ray.map_check_y += 1;
    data->ray.tmp_x += (60/tan(data->player.tmp_angle));
    data->ray.map_check_x = data->ray.tmp_x/60;
    return (data->ray.ray_y);
}
...
{
    data->ray.ray_y += 60/cos(data->player.tmp_angle);
    data->ray.map_check_y += 1;
    data->ray.tmp_x -= 60 * (tan(data->player.tmp_angle));
    data->ray.map_check_x = data->ray.tmp_x/60;
    return (data->ray.ray_y);
